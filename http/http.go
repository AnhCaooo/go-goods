...
type HTTPError struct {
	...
	TranslationKey string `json:"translation_key,omitempty"` // TranslationKey is an optional field that can be used to provide a key for translation purposes.
}
...
func Error(w http.ResponseWriter, statusCode int, message, translationKey string) {
	httpError := HTTPError{
		Code:    statusCode,
